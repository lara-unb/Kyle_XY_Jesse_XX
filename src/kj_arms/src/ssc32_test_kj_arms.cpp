/***************************************************************************************************
*** Arquivo: ssc32_test_kj_arms.cpp
*** Conteudo: SSC32
*** Modificado por: Felipe Luis Rodrigues Sousa
*** Código fonte: https://github.com/mnovo/lynxmotion_ros/blob/master/src/test_ssc32.cpp
****************************************************************************************************/
...
bool check_arg_is_int( char *str )
{
	if( !is_int( str ) )
	{
		std::cout << "Argumento invalido '" << str << "'" << std::endl;
		return false;
	}
...
int main( int argc, char **argv )
{
	...
	if( argc < 2 )
	{
		std::cout << argv[0] << ": Voce deve especificar um comando" << std::endl;
