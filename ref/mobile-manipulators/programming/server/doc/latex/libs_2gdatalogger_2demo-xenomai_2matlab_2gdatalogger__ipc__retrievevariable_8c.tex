...
\label{libs_2gdatalogger_2demo-xenomai_2matlab_2gdatalogger__ipc__retrievevariable_8c}\index{gdatalogger\_\-ipc\_\-retrievevariable.c@{gdatalogger\_\-ipc\_\-retrievevariable.c}}
...
\index{libs/gdatalogger/demo-\/xenomai/matlab/gdatalogger\_\-ipc\_\-retrievevariable.c@{libs/gdatalogger/demo-\/xenomai/matlab/gdatalogger\_\-ipc\_\-retrievevariable.c}!mexFunction@{mexFunction}}
\index{mexFunction@{mexFunction}!libs/gdatalogger/demo-xenomai/matlab/gdatalogger_ipc_retrievevariable.c@{libs/gdatalogger/demo-\/xenomai/matlab/gdatalogger\_\-ipc\_\-retrievevariable.c}}
\subsubsection[{mexFunction}]{\setlength{\rightskip}{0pt plus 5cm}void mexFunction (int {\em nlhs}, \/  mxArray $\ast$ {\em plhs}[$\,$], \/  int {\em nrhs}, \/  const mxArray $\ast$ {\em prhs}[$\,$])}\label{libs_2gdatalogger_2demo-xenomai_2matlab_2gdatalogger__ipc__retrievevariable_8c_a6a215cbfde54f82a3ce599228fc3fce5}
